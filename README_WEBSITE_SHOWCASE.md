...
![Login page preview](assets/readme/login-page-preview.svg)

### Dashboard Page

![Dashboard page preview](assets/readme/dashboard-page-preview.svg)
...
- The website preview images are based on the real page layout and styling from the repository so they render cleanly in GitHub README view.
- The code and test screenshots show the actual code structure and included backend test suite. I was not able to capture a live passing terminal run from this environment because package installation is blocked here.
